  ...
  return (
    ...
    >
      <div className="col-[3_/_12] row-[1] z-10 md:mix-blend-difference text-dark md:text-light test-effect">
        ...
        <p className="text-xl md:text-4xl mb-md">
          Write us an email <br />
          and get in touch!
        </p>
        <p className="text-xl md:text-4xl font-light underline mb-xs hover:opacity-50 effect--300">
          {' '}
          <a className="" href="mailto:nadiathaimassagewellness@gmail.com">
          nadiathaimassagewellness@gmail.com
          </a>
        </p>
        <p className="text-xl md:text-4xl font-light">+31 643-5649-92</p>
      </div>
